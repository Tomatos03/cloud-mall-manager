<template>
    <div class="p-6 bg-[#f4f7fe] min-h-screen overflow-y-auto text-[#2d3748]">
        <div class="max-w-4xl mx-auto">
            ...
            <!-- 主体配置卡片 -->
            <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 transition-all hover:shadow-md mb-8" v-loading="loading">
                <el-form
                    ref="formRef"
                    :model="formData"
                    :rules="rules"
                ...
                >
                    ...
                    <div class="mb-12">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-xs text-gray-400">建议尺寸 1200x600，支持 JPG/PNG/WebP</span>
                        </div>
                            ...
                            >
                                ...
                                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <el-upload
                                        ...
                                        :http-request="(options: any) => handleUpload(options, 'banner')"
                                        :before-upload="beforeUpload"
                                    >
                                        <el-button type="primary" class="!rounded-xl px-6">更换横幅图片</el-button>
                                    </el-upload>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
                        ...
                        <div class="md:col-span-4 flex flex-col items-center">
                            <div class="w-full flex flex-col items-center mb-6">
                                <h3 class="text-sm font-bold text-gray-700 flex items-center gap-2 mb-1">
                            ...
                            <div class="relative group avatar-upload-wrapper">
                                ...
                                <el-upload
                                    ...
                                    action="#"
                                    :show-file-list="false"
                                    :http-request="(options: any) => handleUpload(options, 'avatarUrl')"
                                    :before-upload="beforeUpload"
                                >
                            ...
                            <div class="mt-6 text-center">
                                <p class="text-xs text-gray-400 leading-relaxed">支持 JPG/PNG/WebP</p>
                                <p class="text-xs text-gray-400 leading-relaxed">文件大小不超过 2MB</p>
                            </div>
                        </div>
