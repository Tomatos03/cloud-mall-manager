<template>
    <div class="flex min-h-screen bg-[#f4f7fe]">
        <!-- 左侧：品牌展示区 -->
        <div class="hidden lg:flex lg:w-1/2 bg-linear-to-br from-[#409eff] to-[#337ecc] p-12 flex-col justify-between text-white relative overflow-hidden z-10 shadow-[10px_0_40px_rgba(0,0,0,0.1)]">
            <!-- 装饰性背景元素 -->
            <div class="absolute top-[-10%] right-[-10%] w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
            <div class="absolute bottom-[-5%] left-[-5%] w-96 h-96 bg-black/10 rounded-full blur-3xl"></div>
            ...
            <div class="relative z-10">
                ...
                <div class="mt-20">
                    ...
                    <p class="text-lg text-blue-50 max-w-md leading-relaxed opacity-90 drop-shadow-md">
...
-10 flex items-center gap-6 text-sm text-blue-100/80">
        ...
        <!-- 右侧：表单操作区 -->
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 bg-white border-l border-gray-100">
...
<script setup lang="ts">
    ...
    import { componentResolver } from '@/router'
